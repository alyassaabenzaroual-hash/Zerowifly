...
for i, tab in ipairs(TabsList) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        if tab == "Aimbot" then
            ...
            CreateToggle("🗡️ FOV Circle", "FOVCircle")
...
print("=" .. string.rep("=", 50))
print("🔥 GHOST HUB V7.2 - LOADED SUCCESSFULLY")
print("=" .. string.rep("=", 50))
print("✅ Auto Fire - إطلاق نار تلقائي")
print("✅ Aim AI + Normal Aimbot + Silent Aim")
print("✅ ESP with Boxes + Lines + Counter")
print("✅ FOV Circle مع دائرة تصويب")
