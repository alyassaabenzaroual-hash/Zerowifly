--[[
    ...
    Supports: Mobile/PC | Aimbot | ESP | Auto Fire | Anti-Detection
    Credit: Ghost Hub
--]]
...
local TabsList = {"Aimbot", "WOR🔥", "ESP", "Misc"}
...
for i, tab in ipairs(TabsList) do
    ...
    btn.Position = UDim2.new(0, (i - 1) * 112 + 5, 0, 2)
    btn.Text = tab
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        elseif CurrentTab == "WOR🔥" then
            CreateHeader("🔥 AUTO FIRE SYSTEM")
            CreateToggle("🎯 AUTO FIRE (WOR🔥)", "AutoFire")
            CreateSlider("Fire Delay (ms)", "AutoFireDelay", 0.03, 0.25, 2)
            ...
            statusLabel.Text = "⚡ Auto Fire يضرب الأعداء تلقائياً\n🎯 يعمل بدون تحريك الكاميرا"
...
--// ========== STARTUP ==========
Notify("🔥 GHOST HUB V7.2 Loaded!", Color3.fromRGB(0, 255, 200))

print("=" .. string.rep("=", 50))
print("🔥 GHOST HUB V7.2 - ULTIMATE AUTO FIRE")
print("=" .. string.rep("=", 50))
print("✅ Auto Fire (WOR🔥) - يعمل تلقائياً")
print("✅ Aim AI + Normal Aimbot")
print("✅ ESP + FOV Circle")
